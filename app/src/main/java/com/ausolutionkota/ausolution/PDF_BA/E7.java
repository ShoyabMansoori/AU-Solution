...
public class E7 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/ba/ba1/2018/political science /p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(E7.this, Ba.class));
        }
    }
}