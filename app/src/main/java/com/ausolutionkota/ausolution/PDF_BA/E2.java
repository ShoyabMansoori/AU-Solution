...
public class E2 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/ba/ba1/2018/economics/p2");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(E2.this, Ba.class));
        }
    }
}