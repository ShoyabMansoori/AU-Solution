...
public class E81 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/ba/ba2/2018/sociology/p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(E81.this, Ba.class));
        }
    }
}