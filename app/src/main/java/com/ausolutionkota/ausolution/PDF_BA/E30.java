...
public class E30 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/ba/ba1/2019/geography/p2");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(E30.this, Ba.class));
        }
    }
}