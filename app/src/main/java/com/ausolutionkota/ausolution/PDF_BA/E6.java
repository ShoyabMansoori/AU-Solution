...
public class E6 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/ba/ba1/2018/geography/p2");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(E6.this, Ba.class));
        }
    }
}