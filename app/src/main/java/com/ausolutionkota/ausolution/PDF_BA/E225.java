...
public class E225 extends AppCompatActivity {
    private TextView text1;
    private PDFView pdfview;
    private DotsLoaderBaseView circularDotsLoader;
    private FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference sho = database.getReference("ug/compulsory ba/ba1/2020/hindi compulsory");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sho.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                text1.setText(value);
                Toast.makeText(E225.this, "Loading....", Toast.LENGTH_SHORT).show();
                String url = text1.getText().toString();
                new E225.Retrive().execute(url);
                circularDotsLoader=findViewById(R.id.circularDotsLoader);
                circularDotsLoader.setVisibility(View.INVISIBLE);
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(E225.this, "Failed to load", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(E225.this, Ba.class));
        }
    }
}