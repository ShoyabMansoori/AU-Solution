...
public class A43 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba2/2019/human behavior inorganization");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A43.this, Bba.class));
        }
    }
}