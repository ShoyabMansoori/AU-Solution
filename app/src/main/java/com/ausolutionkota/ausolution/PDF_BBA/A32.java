...
public class A32 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba2/2018/financial management");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A32.this, Bba.class));
        }
    }
}