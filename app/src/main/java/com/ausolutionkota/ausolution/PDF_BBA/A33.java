...
public class A33 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba2/2018/human behavior inorganization");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A33.this, Bba.class));
        }
    }
}