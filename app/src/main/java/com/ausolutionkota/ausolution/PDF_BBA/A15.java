...
public class A15 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba1/2019/financial accounting");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A15.this, Bba.class));
        }
    }
}