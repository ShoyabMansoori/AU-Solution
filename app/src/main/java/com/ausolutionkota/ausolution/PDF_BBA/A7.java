...
public class A7 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba1/2018/fundamentals of entrepreneurship");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A7.this, Bba.class));
        }
    }
}