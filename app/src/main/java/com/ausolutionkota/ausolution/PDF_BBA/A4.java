...
public class A4 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba1/2018/business mathematics");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A4.this, Bba.class));
        }
    }
}