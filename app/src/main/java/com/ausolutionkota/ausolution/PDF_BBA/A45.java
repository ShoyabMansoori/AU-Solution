...
public class A45 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba2/2019/marketing management");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A45.this, Bba.class));
        }
    }
}