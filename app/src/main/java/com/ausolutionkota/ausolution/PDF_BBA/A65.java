...
public class A65 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba3/2018/marketing strategy and research");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A65.this, Bba.class));
        }
    }
}