...
public class A97 extends AppCompatActivity {
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A97.this, Bba.class));
        }
    }
}