...
public class A36 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba2/2018/production and operations management");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A36.this, Bba.class));
        }
    }
}