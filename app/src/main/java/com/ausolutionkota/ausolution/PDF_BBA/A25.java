...
public class A25 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bba/bba1/2020/fundamentals of entrepreneurship");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(A25.this, Bba.class));
        }
    }
}