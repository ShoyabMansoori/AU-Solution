...
public class G4 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom1/2018/Business Administration/p2");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G4.this, Bcom.class));
        }
    }
}