...
public class G3 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom1/2018/Business Administration/p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G3.this, Bcom.class));
        }
    }
}