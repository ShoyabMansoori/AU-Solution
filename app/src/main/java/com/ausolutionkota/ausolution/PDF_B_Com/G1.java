...
public class G1 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom1/2018/Accountancy and Business Statistics/p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G1.this, Bcom.class));
        }
    }
}