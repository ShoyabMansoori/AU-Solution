...
public class G21 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom2/2018/Business Administration/p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G21.this, Bcom.class));
        }
    }
}