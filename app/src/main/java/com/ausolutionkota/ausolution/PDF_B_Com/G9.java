...
public class G9 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom1/2019/Business Administration/p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G9.this, Bcom.class));
        }
    }
}