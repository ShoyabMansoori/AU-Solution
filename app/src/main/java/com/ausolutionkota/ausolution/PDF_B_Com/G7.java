...
public class G7 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom1/2019/Accountancy and Business Statistics/p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G7.this, Bcom.class));
        }
    }
}