...
public class G20 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom2/2018/Accountancy and Business Statistics/p2");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G20.this, Bcom.class));
        }
    }
}