...
public class G22 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom2/2018/Business Administration/p2");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G22.this, Bcom.class));
        }
    }
}