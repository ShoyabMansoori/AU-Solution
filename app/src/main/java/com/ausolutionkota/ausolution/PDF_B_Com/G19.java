...
public class G19 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bcom/bcom2/2018/Accountancy and Business Statistics/p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G19.this, Bcom.class));
        }
    }
}