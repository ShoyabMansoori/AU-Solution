...
public class G72 extends AppCompatActivity {
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G72.this, Bcom.class));
        }
    }
}