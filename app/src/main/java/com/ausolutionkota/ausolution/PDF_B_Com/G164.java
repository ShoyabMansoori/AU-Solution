...
public class G164 extends AppCompatActivity {
    private TextView text1;
    private PDFView pdfview;
    private DotsLoaderBaseView circularDotsLoader;
    private FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference sho = database.getReference("pg/mcom/final/2018/accountancy_and_business_statistics p6");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sho.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                text1.setText(value);
                Toast.makeText(G164.this, "Loading....", Toast.LENGTH_SHORT).show();
                String url = text1.getText().toString();
                new G164.Retrive().execute(url);
                circularDotsLoader=findViewById(R.id.circularDotsLoader);
                circularDotsLoader.setVisibility(View.INVISIBLE);
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(G164.this, "Failed to load", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(G164.this, Mcom.class));
        }
    }
}