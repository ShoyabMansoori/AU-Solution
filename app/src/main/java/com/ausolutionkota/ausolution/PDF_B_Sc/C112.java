...
public class C112 extends AppCompatActivity {
    private TextView text1;
    private PDFView pdfview;
    private DotsLoaderBaseView circularDotsLoader;
    private FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference sho = database.getReference("ug/bsc/bsc3/2019/chemistry/p1");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sho.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                text1.setText(value);
                Toast.makeText(C112.this, "Loading....", Toast.LENGTH_SHORT).show();
                String url = text1.getText().toString();
                new C112.Retrive().execute(url);
                circularDotsLoader=findViewById(R.id.circularDotsLoader);
                circularDotsLoader.setVisibility(View.INVISIBLE);
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(C112.this, "Failed to load", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(C112.this, Bsc.class));
        }
    }
}