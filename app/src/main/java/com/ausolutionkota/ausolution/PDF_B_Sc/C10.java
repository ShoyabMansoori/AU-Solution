...
public class C10 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bsc/bsc1/2018/zoology/p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(C10.this, Bsc.class));
        }
    }
}