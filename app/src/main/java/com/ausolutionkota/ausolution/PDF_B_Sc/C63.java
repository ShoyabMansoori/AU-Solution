...
public class C63 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bsc/bsc2/2019/physics/p3");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(C63.this, Bsc.class));
        }
    }
}