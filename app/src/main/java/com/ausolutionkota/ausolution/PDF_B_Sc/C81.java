...
public class C81 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bsc/bsc2/2020/maths/p3");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(C81.this, Bsc.class));
        }
    }
}