...
public class C96 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bsc/bsc3/2018/maths/p3");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(C96.this, Bsc.class));
        }
    }
}