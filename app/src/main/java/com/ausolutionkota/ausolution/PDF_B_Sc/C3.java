...
public class C3 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bsc/bsc1/2018/physics/p3");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(C3.this, Bsc.class));
        }
    }
}