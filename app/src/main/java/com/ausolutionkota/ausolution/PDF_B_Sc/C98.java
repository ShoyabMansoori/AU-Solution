...
public class C98 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("ug/bsc/bsc3/2018/chemistry/p2");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(C98.this, Bsc.class));
        }
    }
}