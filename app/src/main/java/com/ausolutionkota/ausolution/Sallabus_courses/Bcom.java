...
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_first_18;
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_first_19;
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_first_20;
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_second_18;
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_second_19;
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_second_20;
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_third_18;
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_third_19;
import com.ausolutionkota.ausolution.Acti_Ug_Paper.Bcom_third_20;
    ...
    private void Click_intents() {
        First_2020.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                First_20();
                startActivity(new Intent(Bcom.this, Bcom_first_20.class));
                animation();
            }
        });
        First_2019.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                First_19();
                startActivity(new Intent(Bcom.this, Bcom_first_19.class));
                animation();
            }
        });
        First_2018.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                First_18();
                startActivity(new Intent(Bcom.this, Bcom_first_18.class));
                animation();
            }
        });
        Second_2020.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Second_20();
                startActivity(new Intent(Bcom.this, Bcom_second_20.class));
                animation();
            }
        });
        Second_2019.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Second_19();
                startActivity(new Intent(Bcom.this, Bcom_second_19.class));
                animation();
            }
        });
        Second_2018.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Second_18();
                startActivity(new Intent(Bcom.this, Bcom_second_18.class));
                animation();
            }
        });
        Third_2020.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Third_20();
                startActivity(new Intent(Bcom.this, Bcom_third_20.class));
                animation();
            }
        });
        Third_2019.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Third_19();
                startActivity(new Intent(Bcom.this, Bcom_third_19.class));
                animation();
            }
        });
        Third_2018.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Third_18();
                startActivity(new Intent(Bcom.this, Bcom_third_18.class));
                animation();
            }
        });
