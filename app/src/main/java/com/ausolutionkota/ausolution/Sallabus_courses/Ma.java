...
import com.ausolutionkota.ausolution.Acti_Pg_Paper.Ma_first_18;
import com.ausolutionkota.ausolution.Acti_Pg_Paper.Ma_first_19;
import com.ausolutionkota.ausolution.Acti_Pg_Paper.Ma_first_20;
import com.ausolutionkota.ausolution.Acti_Pg_Paper.Ma_second_18;
import com.ausolutionkota.ausolution.Acti_Pg_Paper.Ma_second_19;
import com.ausolutionkota.ausolution.Acti_Pg_Paper.Ma_second_20;
    ...
    private void Click_intents() {
        Previous_2020.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Previous_20();
                startActivity(new Intent(Ma.this, Ma_first_20.class));
                animation();
            }
        });
        Previous_2019.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Previous_19();
                startActivity(new Intent(Ma.this, Ma_first_19.class));
                animation();
            }
        });
        Previous_2018.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Previous_18();
                startActivity(new Intent(Ma.this, Ma_first_18.class));
                animation();
            }
        });
        Final_2020.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Final_20();
                startActivity(new Intent(Ma.this, Ma_second_20.class));
                animation();
            }
        });
        Final_2019.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Final_19();
                startActivity(new Intent(Ma.this, Ma_second_19.class));
                animation();
            }
        });
        Final_2018.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Final_18();
                startActivity(new Intent(Ma.this, Ma_second_18.class));
                animation();
            }
        });
    }
