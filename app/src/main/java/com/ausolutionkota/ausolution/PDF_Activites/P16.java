...
public class P16 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bca/bca3/2018/java");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(P16.this, Bca.class));
        }
    }
}