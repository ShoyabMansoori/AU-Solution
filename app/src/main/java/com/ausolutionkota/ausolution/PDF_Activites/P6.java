...
public class P6 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bca/bca2/2019/operating system");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(P6.this, Bca.class));
        }
    }
}