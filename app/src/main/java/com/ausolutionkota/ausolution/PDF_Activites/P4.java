...
public class P4 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bca/bca2/2018/data electronics");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(P4.this, Bca.class));
        }
    }
}