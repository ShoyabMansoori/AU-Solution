...
public class P10 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bca/bca2/2019/data communication comman netwark");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(P10.this, Bca.class));
        }
    }
}