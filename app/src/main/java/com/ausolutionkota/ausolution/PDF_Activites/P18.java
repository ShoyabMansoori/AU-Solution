...
public class P18 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bca/bca3/2018/visual programming");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(P18.this, Bca.class));
        }
    }
}