...
public class P38 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("professional/bca/bca1/2019/evs");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(P38.this, Bca.class));
        }
    }
}