...
public class H10 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("pg/msc/final/2018/chemistry p5");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(H10.this, Msc.class));
        }
    }
}