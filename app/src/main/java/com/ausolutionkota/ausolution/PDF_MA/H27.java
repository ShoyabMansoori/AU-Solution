...
public class H27 extends AppCompatActivity {
    private TextView text1;
    private PDFView pdfview;
    private DotsLoaderBaseView circularDotsLoader;
    private FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference sho = database.getReference("pg/msc/final/2018/zoology p5");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(H27.this, Msc.class));
        }
    }
}