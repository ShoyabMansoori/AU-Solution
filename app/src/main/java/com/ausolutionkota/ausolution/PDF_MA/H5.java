...
public class H5 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("pg/msc/privious/2018/zoology p3");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(H5.this, Msc.class));
        }
    }
}