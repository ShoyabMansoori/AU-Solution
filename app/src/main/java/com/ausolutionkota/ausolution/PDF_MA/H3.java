...
public class H3 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("pg/msc/privious/2018/zoology p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(H3.this, Msc.class));
        }
    }
}