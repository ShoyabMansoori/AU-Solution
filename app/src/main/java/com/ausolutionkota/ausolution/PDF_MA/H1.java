...
public class H1 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("pg/msc/privious/2018/physics p3");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(H1.this, Msc.class));
        }
    }
}