...
public class H4 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("pg/msc/privious/2018/zoology p2");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(H4.this, Msc.class));
        }
    }
}