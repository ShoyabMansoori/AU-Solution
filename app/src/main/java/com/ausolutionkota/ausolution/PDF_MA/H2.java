...
public class H2 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("pg/msc/privious/2018/physics p4");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(H2.this, Msc.class));
        }
    }
}