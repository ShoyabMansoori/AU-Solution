...
public class H6 extends AppCompatActivity {
    ...
    DatabaseReference sho = database.getReference("pg/msc/final/2018/chemistry p1");
    @Override
    ...
    private void Check_enternet(){
        ...
        if(null!=networkInfo){
            ...
            startActivity(new Intent(H6.this, Msc.class));
        }
    }
}